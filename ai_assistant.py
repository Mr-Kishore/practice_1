...
def sendEmail(to, content):
    server = smtplib.SMTP('kishoretheshuttler@gmail.com', 587)
    server.ehlo()
    server.starttls()
    server.login('kishoreprogramminghub@gmail.com', '123')
    server.sendmail('kishoreprogramminghub@gmail.com', to, content)
    server.close()
